...
alpha0 = 1.8; T = 50;
#Uncomment the desired evolution computation.
#mm1, mm2, mm3, pp1, pp2, pp3, t = deterministic_evolution(alpha0) #Change alpha_0 to obtain the different graphs
#mm1, mm2, mm3, pp1, pp2, pp3, t = guillespie_evolution(V,alpha0,T=50) #Change alpha_0 to obtain the different graphs
